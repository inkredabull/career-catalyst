...
FUNCTIONS: ${functions.join(', ')}`;
  ...
  /**
   * Extract Situation and Task from a Challenge description (STAR decomposition).
   * Returns a pipe-separated string: "Situation|Task"
   * @param challenge - The challenge/situation narrative
   * @returns Pipe-separated "Situation|Task" string
   */
