...
export const buildSmsMessage = (first: string, email: string, topic: string): string =>
  [
...
export const notifyViaSMS = (first: string, email: string, number: string, topic: string): void => {
